...
#define STRING_CONFIG_H_AUTHOR "Denis Ferrero" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prusa I3 Pro"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp  90.26
  #define DEFAULT_bedKi  17.49
  #define DEFAULT_bedKd 310.56
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 113.3 }
 ...
 */
// -- Custom condition
#define PROBE_WITH_FUN_DUCT

#if ENABLED(PROBE_WITH_FUN_DUCT)
  #define NOZZLE_TO_PROBE_OFFSET { -25, -41, -4.25 }
#else
  #define NOZZLE_TO_PROBE_OFFSET { 4, -43, -3.23 }
#endif
